...
#TruthE1 = infile1.Get('ms_ROI_Erecon_TruthFV_NeutronSelection_TruthEtrain')
TruthE1 = infile1.Get('ms_ROI_Erecon_NR_WSFV_NeutronSelection_TruthEtrain')
#TruthE1 =  infile1.Get('Eparent_neutron')
#TruthE1_weighted =  infile_weighted.Get('Eparent_neutron')
ReconE1 = infile2.Get('msFidu_Erecon_NR')
ReconE1_copy = infile2_copy.Get('msFidu_Erecon_NR')
ReconE1_dev = infile3.Get('msFidu_Erecon_NR')
ReconE1_dev_copy = infile3_copy.Get('msFidu_Erecon_NR')
...
TruthE1.SetTitle("AmLi MS Energy") 
