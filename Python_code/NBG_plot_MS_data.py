...
infile= ROOT.TFile.Open('/global/cfs/cdirs/lz/users/madan12/SR1_WIMPs_Search/ALPACA_April06/run/SR1ana/MS_TPC_Neutron_April06_v2.root', 'read')
canvas = ROOT.TCanvas('canvas', '', 700, 500)
#s1vs2 = infile.Get('s1s2Area_SS_BC_FV_HR_S2W_AA_s2ST_ET')
s1vs2 = infile.Get('s1s2Area_MS_FV_HR_S2W_AA_s2ST_ET_ROI')
s1vs2.Draw()
...
# For MS NR Band from LZLAMA
meanband_par=[-2.19750278e+01,  2.26043271e+01,  1.00873388e-03,  4.26715264e+00]
lowband_par=[-2.32152104e+01,  2.18687904e+01,  6.10088427e-04,  4.15920346e+00]
upband_par=[-2.08383169e+01,  2.35787153e+01,  1.40317082e-03,  4.37620174e+00]
...
canvas.SaveAs('s1s2Area_MS_FV_HR_S2W_AA_s2ST_ET_ROI_April07_v2.png')